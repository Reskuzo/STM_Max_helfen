/*
 * snake_adapted.h
 * Adapted for STM32H735G-DK board
 *
...
/* Display constants – scaled for 480×272 */
#define SNAKE_CELL_SIZE   20
#define SNAKE_COLS        24   /* 480 / 20 */
#define SNAKE_ROWS        13   /* 260 / 20 (leave header/footer rows) */
#define SNAKE_BOARD_SIZE  (SNAKE_COLS * SNAKE_ROWS)  /* 312 */
