/*
 * state_machiene.c - H735G-DK adaptation
 */
...
state_t pages[] = {
    { "Wavefront",     wavefront_init,           wavefront_onTick,
      raise_inc,       lower_inc,                raise_noise_threshold, lower_noise_threshold, toggle_thres_vol,
      "+inc",          "-inc",                   "+threshold",          "-threshold",           "thr/vol" },
    { "Fourier",       fourier_init,             fourier_onTick,
      fourier_cursor_left, fourier_cursor_right, fourier_toggle_hold,   blank,                 fourier_toggle_scale,
      "-freq.",        "+freq.",                 "hold",                "",                    "log/lin" },
    { "Noise Filters", noise_filter_page_init,   noise_filter_page_onTick,
      blank,           blank,                    noise_filter_page_cursor_up, noise_filter_page_cursor_down, noise_filter_page_toggle,
      "",              "",                       "up",                  "down",                "toggle" }
};
uint8_t num_pages = 3;
...
void joy_forwarding(uint32_t joypin)
{
    ...
    else /* not in nav mode -> relay to pages */
    {
